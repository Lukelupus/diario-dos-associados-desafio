...
function Bottom() {
  ...
  return (
    <section className="bottom-section">
      <div className="fique-informado">
        <span className="fique-sempre">Fique sempre bem informado.</span>
      ...
      <div className="newsletter-box">
        ...
        <form className="newletter-form" onSubmit={onSubmit}>
          <input
            className="envie-email"
            type="email"
            placeholder="DIGITE SEU EMAIL"
            onChange={onChange}
            value={email}
          ></input>
          <button className="btn-send">Receber</button>
        </form>
      </div>
      <div className="social-bottom">
        <span className="compartilhe">compartilhe</span>
        <div className="social-networks networks-bottom">
          <div
            className="social-circle facebook facebook-bottom"
            href="/"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <div
            className="social-circle twitter twitter-bottom"
            href="/"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <div className="social-circle whatsapp whatsapp-bottom">
            <a
